                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    @enderror">
                                        ...
                                        <option @if (old('year') == 2023) selected="selected" @endif
                                            value="2023">2023</option>

                                        <option @if (old('year') == 2024) selected="selected" @endif
                                            value="2024">2024</option>

                                        <option @if (old('year') == 2025) selected="selected" @endif
                                            value="2025">2025</option>

                                        <option @if (old('year') == 2026) selected="selected" @endif
                                            value="2026">2026</option>

                                        <option @if (old('year') == 2027) selected="selected" @endif
